...
#     The client must now perform decryption locally using the /verify endpoint
#     to get the key pieces (k_public, k_private).
#     """
#     return jsonify({"error": "Endpoint removed. Use client-side decryption."}), 410
